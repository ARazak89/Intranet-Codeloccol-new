                    ...
                    <div key={slot._id} className="list-group-item d-flex justify-content-between align-items-center flex-wrap py-3 list-group-item-action">
                      <div>
                        <h5 className="mb-1 text-primary d-flex align-items-center">
                          ...
                          <span>
                            {new Date(slot.startTime).toLocaleDateString()} de {new Date(slot.startTime).getUTCHours().toString().padStart(2, '0')}:{new Date(slot.startTime).getUTCMinutes().toString().padStart(2, '0')} à {new Date(slot.endTime).getUTCHours().toString().padStart(2, '0')}:{new Date(slot.endTime).getUTCMinutes().toString().padStart(2, '0')}
                          </span>
                        </h5>
