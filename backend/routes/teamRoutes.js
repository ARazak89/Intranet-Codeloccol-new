...
import {
  ...
  deleteTeam,
  getMyTeamForHackathon, // Nouvelle fonction de contrôleur
...
router.get('/my-team/hackathon/:hackathonId', requireAuth, requireRole(['apprenant']), getMyTeamForHackathon); // Nouvelle route pour les apprenants
