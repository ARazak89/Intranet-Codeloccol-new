...
// Route pour mettre à jour un projet (template ou assignation)
router.put("/:id", requireAuth, requireRole(["staff", "admin"]), updateProject); // Mettre à jour un projet existant
...
// Nouvelle route pour récupérer les projets annulés (Staff/Admin)
router.get("/cancelled", requireAuth, requireRole(["staff", "admin"]), getCancelledProjects);
