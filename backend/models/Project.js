...
const assignmentSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['assigned', 'submitted', 'pending_review', 'awaiting_staff_review', 'approved', 'rejected'], default: 'assigned' },
...
const projectSchema = new mongoose.Schema({
  ...
  order: { type: Number }, // Supprimez la valeur par défaut ici
