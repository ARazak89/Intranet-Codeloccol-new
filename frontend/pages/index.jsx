  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Plateforme d'apprentissage collaboratif pour développeurs"
        />
      </Head>

      <div className="text-center mb-5 pt-5">
        <h1 className="display-4 fw-bold">
          Bienvenue sur <span className="text-primary">CodeLoccol</span>
        </h1>
        <p className="lead  mt-3">
          Votre plateforme collaborative pour apprendre, coder et grandir
          ensemble.
        </p>
      ...
      <div className="row my-5">
        <div className="col-md-4 text-center mb-4">
          ...
          <p className="">
            Travaillez sur des projets réels, obtenez des retours et améliorez
            vos compétences en équipe.
          </p>
        </div>
        <div className="col-md-4 text-center mb-4">
          <div className="icon-feature mb-3">
          ...
          <p className="">
            Participez à des défis intenses, évaluez vos pairs et grimpez dans
            le classement.
          </p>
        </div>
        <div className="col-md-4 text-center mb-4">
          ...
          <p className="">
            Gagnez des badges, progressez en niveau et suivez votre parcours
            d'apprentissage.
          </p>
        </div>
      </div>

      <div className="text-center my-5 p-4 rounded shadow-sm">
        <h2 className="fw-bold mb-3">Prêt à commencer votre aventure ?</h2>
        <p className="lead ">
          Rejoignez des milliers de développeurs et transformez votre
          apprentissage.
        </p>
