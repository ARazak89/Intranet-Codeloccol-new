...
export default function Profile() {
  ...
  const handleUpdateProfilePicture = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        throw new Error(
          data.message || "Échec de la mise à jour de la photo de profil."
        );
      }
    } catch (e) {
  ...
  return (
    <div className="container-fluid mt-4 pt-5 px-4">
      ...
      <div className="thm-bg thm-shadow-s mb-4 rounded-3 p-3">
          ...
          <div className="row">
            <div className="col-md-6 mb-3">
              <p className="d-flex align-items-center mb-1">
                <strong className="me-2">
                  <i className="bi bi-briefcase me-2 text-primary"></i>Rôle:
                </strong>{" "}
                <span className="badge bg-primary">{user.role}</span>
              </p>
              <p className="d-flex align-items-center mb-1">
                <strong className="me-2">
                  <i className="bi bi-activity me-2 text-success"></i>Statut:
                </strong>{" "}
            ...
            <div className="col-md-6 mb-3">
              {user.role === "apprenant" && (
                <p className="d-flex align-items-center mb-1">
                  <strong className="me-2">
                    <i className="bi bi-graph-up me-2 text-info"></i>Niveau:
                  </strong>{" "}
                  {user.level}
                </p>
              )}
        ...
        <div className="modal" tabIndex="-1" style={{ display: "block" }}>
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="d-flex justify-content-between p-3 thm-bg rounded-top-3">
              ...
              <div className="modal-body thm-bg-light rounded-bottom-3">
                {error && (
                ...
                <form onSubmit={handleUpdateProfilePicture}>
                  <div className="mb-3">
                    <label htmlFor="profilePictureFile" className="form-label">
                  ...
                  <button
                    type="submit"
                    className="btn thm-bg thm-shadow-m d-flex align-items-center"
                  >
      ...
      {showPasswordModal && (
        <div className="modal" tabIndex="-1" style={{ display: "block" }}>
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="thm-bg d-flex justify-content-between p-3 rounded-top-3">
              ...
              <div className="modal-body rounded-bottom-3 thm-bg-light">
                {error && (
                  <div className="alert alert-danger mb-3" role="alert">
                    {error}
                  </div>
                ...
                <form onSubmit={handleChangePassword}>
                  <div className="mb-3">
                    <p htmlFor="oldPassword" className="form-label">
                      Ancien Mot de Passe
                    </p>
                    <input
                      type="password"
                  ...
                  <div className="mb-3">
                    <p htmlFor="newPassword" className="form-label">
                  ...
                  <div className="mb-3">
                    <p htmlFor="confirmNewPassword" className="form-label">
      ...
      {(showPasswordModal || showProfilePictureModal) && (
